...
# for example i made 2 python files one is called game.py and the other is draw.py

#The Python script game.py implements the game.
#  It uses the function draw_game from the file draw.py, 
# or in other words,
#  the draw module that implements the logic for drawing the game on the screen.
