...
# reuse it and save some time. Also functions are a key way to define interfaces so programmers can share their code.

# Example of a function :
'''
def my_function(): # Declaring function
...
# In this exercise you'll use an existing function, and while adding your own to create a fully functional program.
   ...
   # Add a function named build_sentence(info) which receives a single argument containing 
   # a string and returns a sentence starting with the given string and ending with the string " is a benefit of functions!"
