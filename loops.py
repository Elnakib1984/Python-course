...
# 1 - for loop
'''
games = ["Assassin's Creed", "Call of duty", "Watch dogs"]
# game takes the value of each element in the list games one by one, and print(game) prints the current element.
for game in games :
  print(game)
'''
# for loop is used to iterate over a sequence (like a list, tuple, string, or range). 
# It allows you to repeat a block of code for each element in the sequence.
...
# 2 - while loops 
# while loops repeat as long as certain boolean condition is met.
'''
count = 0
while count <= 5:
    print(count)
...
#  4 - Can we use "else" clause for loops?
